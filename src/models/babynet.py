...
class VideoResNet(nn.Module):
    ...
    def __init__(self, block, conv_makers, layers,
                 stem, num_classes=1, msha=False, n_frames_last_layer=2, input_last_layer=(7, 7)):
...
# VideoResNet based on: https://github.com/pytorch/vision/blob/5a315453da5089d66de94604ea49334a66552524/torchvision/models/video/resnet.py#L285
# MHSA based on: https://github.com/leaderj1001/BottleneckTransformers/blob/main/model.py
def BabyNet(msha=False, n_frames=16, input_size=(224, 224), **kwargs):
