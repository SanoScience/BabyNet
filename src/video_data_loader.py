...
class FetalWeightVideo(Dataset):
    ...
    def __init__(self,
                 ...
                 background_frames_filename: str = "background_frames.csv",
        ...
        Args:
            ...
            mode:
        """
        self.input_path = os.path.join(input_path, "BabyWeightVideo_frames")
        ...
        self.weight_labels = pd.read_csv("../data/baby_weight.csv", sep=";", usecols=["ID", "weight"])
        ...
        for i in self.patient_id:
            frames = glob.glob(f"{self.input_path}/video_{i}/*.png")
    ...
    def __getitem__(self, x):
        ...
        weight = self.weight_labels.loc[self.weight_labels["ID"] == int(patient_id), "weight"]
        weight = weight.item()
        ...
        return video_stack, weight, self.patient_id_by_chunk[x], body_part, first_frame
